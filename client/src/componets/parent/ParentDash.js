...
function ParentDash({ getMsg, getCompletWork, getHomework, logoutParent, parent: { parent, loading }, parentwork: { homeworks, completework }, feedback: {
    parentMsgs
} }) {
    useEffect(() => {
        getHomework()
...
export default connect(mapStateToProps, { getHomework, getCompletWork, getMsg, logoutParent, })(ParentDash)
