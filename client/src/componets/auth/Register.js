          ...
          <div className="card">
            <div className="row align-items-stretch text-center">
              <div className="col-md-6 img-card-side">
                <img
                  src="assets/images/auth/homeWork1.png"
                  alt=""
                  className="img-fluid"
                />
              </div>
                ...
                <div className="card-body">
                  <div className="text-left">
                    <h4 className="mb-3 f-w-600">
                      Create{" "}
                      <span className="text-primary"> School Account</span>{" "}
                    </h4>
                    <p className="text-muted mb-4">
                      Welcome Homework App, Please create your account <br />{" "}
