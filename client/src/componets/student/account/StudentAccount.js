        ...
        <div className="pcoded-content">
          ...
          <div className="row">
            <div className="col-xl-12">
              <div className="card user-card user-card-1">
                <div className="card-header border-0 p-2 pb-0 bg-info "></div>
                <div className="card-body pt-0">
                  ...
                  <div className="row text-center">
                    ...
                    <div className="col">
                      ...
                      <span className="badge badge-pill badge-danger ml-5">
                        Pending Homework
                      </span>
                    </div>
                    <div className="col text-info">
                      ...
                      <span className="badge badge-pill badge-info ml-5">
                        Feedback Reports
                      </span>
                    </div>
                  </div>
                ...
                >
                  <form>
                    <div className="form-group row">
                      ...
                      <div className="col-sm-9">{student && student.name}</div>
                    </div>
                    <div className="form-group row">
                      <label className="col-sm-3 col-form-label font-weight-bolder">
                        Gender
                    ...
                    <div className="form-group row">
                      ...
                      <div className="col-sm-9">
                        <Moment format="YYYY/MM/DD">
                          {student && student.joining_year_group}
                        </Moment>
                      </div>
                    </div>
                    ...
                    <div className="form-group row">
                      ...
                      <div className="col-sm-9">
                        <Moment format="YYYY">
                          {student && student.current_year_group}
                        </Moment>
                      </div>
                    </div>
                  </form>
          ...
          <div className="row">
            <div className="col-md-6  py-3 mb-3  ">
              <Link to="/register-parents" className="btn btn-success">
...
export default connect(mapStateToProps, { getParent, logoutStudent })(
  StudentAccount
);
