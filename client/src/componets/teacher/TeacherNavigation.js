                ...
                <div className="pc-mob-header pc-header ">
                    <div className="pcm-logo  ">
                        <ul className="pc-navbar pc__position">
                            ...
                            <li className="pc-item mr-5"><Link className="pc-link text-info" to="/manage-homework"><i className="fas fa-book f-26" /> <br />
                                <small className="mobo__nav">Homework</small></Link></li>
                ...
                <div className="navbar-wrapper">
                    ...
                    <div className="navbar-content">
                        <ul className="pc-navbar">
                            ...
                            <li className="pc-item"><Link className="pc-link text-info" to="/manage-homework"><i className="fas fa-book f-26" /> Manage Homework</Link></li>
