                        ...
                        <div className="row align-items-center">
                            <div className="col-md-12">
                                <ul className="breadcrumb">
                                    <li className="breadcrumb-item">Teacher|| {teacher && teacher.name}</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div className="row">
                    ...
                    <div className="col-xl-4 col-md-4">
                        <div className="card shadow">
                            ...
                            <div className="col-md-12  py-3 mb-3    ">
                                <Link to="/manage-classes" className="btn btn-success">Manage Classes</Link>
                            </div>
                        </div>
                    </div>
                    {/* create homework */}
                    <div className="col-xl-4 col-md-4">
                        <div className="card shadow">
                            ...
                            <div className="col-md-12  py-3 mb-3 ">
                                <Link to="/create-homework" className="btn btn-info">Create Homework</Link>
                            </div>
                        </div>
                    </div>
                    {/* homework submittion */}
                    <div className="col-xl-4 col-md-4">
                        <div className="card shadow">
                            ...
                            <div className="col-md-12 center py-3 mb-3 ">
                                <Link to="/manage-homework" className="btn btn-danger">Manage Homework</Link>
                            </div>
                        </div>
                    </div>
                </div>
