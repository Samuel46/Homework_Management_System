        ...
        <div div className="row dash_width" >
            ...
            <div className="col-xl-3 col-md-6">
                <div className="card shadow">
                    ...
                    <div className="col-md-12  py-3 mb-3 ">
                        <Link to="/create-student" className="btn btn-info">Manage Student</Link>
                    </div>
                </div>
            </div>
            <div className="col-xl-3 col-md-6">
                <div className="card shadow rounded ">
                    ...
                    <div className="col-md-12  py-3 mb-3    ">
                        <Link to="/create-class" className="btn btn-info">Manage Classes</Link>
                    </div>
                </div>
            </div>
            <div className="col-xl-3 col-md-6">
                <div className="card shadow  ">
                    ...
                    <div className="col-md-12  py-3 mb-3  ">
                        <Link to="/create-subject" className="btn btn-info">Manage Subject</Link>
                    </div>
                </div>
            </div>
        </div >
